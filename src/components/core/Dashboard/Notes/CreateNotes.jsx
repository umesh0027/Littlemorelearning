...
const CreateNotes = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${BASE_URL}/notes/category`, {
        name: categoryName,
   ...
   <Topbar/>
    ...
    <div className="min-h-screen p-5 bg-[#f2daed]">
      ...
      <div className="container mx-auto">
        <h1 className="text-3xl font-bold text-center mb-8 text-[#3b3092]">Admin Notes</h1>
        ...
        >
          <h2 className="text-xl font-semibold mb-4">Create Note Category</h2>
          <div className="mb-4">
      ...
      >
        ...
        <div className="flex space-x-3 mt-auto">
          ...
          <button
            onClick={async () => {
              try {
                await axios.delete(`${BASE_URL}/notes/category/${category._id}`);
